      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="./leave/addleave.php"><i class="fa fa-circle-o"></i> درخواست مرخصی جدید</a></li>
            <li><a href="./leave/show_myleave.php"><i class="fa fa-circle-o"></i>نمایش مرخصی های من</a></li>
            <li><a href="pages/layout/fixed.html"><i class="fa fa-circle-o"></i> نمایش مرخصی های کارمندان</a></li>
          ...
          <ul class="treeview-menu">
            <li><a href="./employee/addemployee.php"><i class="fa fa-circle-o"></i> افزودن کارمند جدید</a></li>
            <li><a href="pages/layout/boxed.html"><i class="fa fa-circle-o"></i>نمایش کارمندان</a></li>
        ...
        <li>
          ...
          <i class="fa fa-th"></i> <span>ویجت ها</span></a>
        </li>
        <li class="treeview">
          <a href="#">
        ...
        <li>
          ...
          <i class="fa fa-envelope"></i> <span>ایمیل ها</span></a>
        </li>
        <li class="treeview">
          <a href="#">
